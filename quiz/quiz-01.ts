...
//1. 배열 타입
const bookTitles: string[] = ['title1', 'title2', 'title3', 'title4', 'title5'];
...
function updateBookStatus(book: Book, newStatus: boolean) {
...
function addBookInfo(bookInfo: BookInfo): void {
